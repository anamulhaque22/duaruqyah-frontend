...
import info from "../assets/images/dua-info.svg";
...
const LeftNav = () => {
  return (
    <div className="flex flex-col items-center">
      <div>
        <Link href="#" className="w-14 h-14 inline-block">
          <Image src={Logo} alt="logo" width={73} height={73} />
        </Link>
      </div>
      <ul className="flex gap-y-7 flex-col py-16">
        {LeftNavImages.map((item) => (
          <li
            key={item.id}
        ...
        {/* 
          <li>
            <Link href="#">
              <Image src={allDua} alt="logo" width={73} height={73} />
            </Link>
          </li>
          <li>
            <Link href="#">
              <Image src={memorize} alt="logo" width={73} height={73} />
            </Link>
          </li>
          <li>
            <Link href="#">
              <Image src={ruqyah} alt="logo" width={73} height={73} />
            </Link>
          </li>
          <li>
            <Link href="#">
              <Image src={book} alt="logo" width={73} height={73} />
            </Link>
          </li>

          <li>
            <Link href="#">
              <Image src={info} alt="logo" width={73} height={73} />
            </Link>
          </li>
          <li>
            <Link href="#">
              <Image src={bookmark} alt="logo" width={73} height={73} />
            </Link>
          </li> */}
      </ul>
      <div>
        <Link
          href="#"
          className="bg-[#1FA45B] w-14 h-14 flex items-center justify-center rounded-md"
        >
          <svg
            width="24"
            height="24"
